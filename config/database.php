...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // FreeRADIUS database connection. Defaults to the same database as
        // the main app (shared-schema mode) but can point at a separate
        // "radius" database by setting RADIUS_DB_* env vars.
        'radius' => [
            'driver' => 'mysql',
